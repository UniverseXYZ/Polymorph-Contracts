...
describe('PolymorphWithGeneChangerChild', () => {
  ...
  before(async () => {
    ...
    const PolymorphWithGeneChangerChild = await ethers.getContractFactory("PolymorphWithGeneChangerChild");
    polymorphInstance = await PolymorphWithGeneChangerChild.deploy(name, token, baseUri, daoAddress, defaultGenomeChangePrice, randomizeGenomePrice, arweaveAssetsJSON);
