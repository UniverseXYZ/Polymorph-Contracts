...
describe('PolymorphWithGeneChangerRoot', () => {
  ...
  before(async () => {
    ...
    const PolymorphWithGeneChangerRoot = await ethers.getContractFactory("PolymorphWithGeneChangerRoot");
    polymorphInstance = await PolymorphWithGeneChangerRoot.deploy(name, token, baseUri, daoAddress, premintedTokensCount, defaultGenomeChangePrice, polymorphPrice, totalSupply, randomizeGenomePrice, bulkBuyLimit, arweaveAssetsJSON, polymorphV1Address);
